// Notes :- ek array hoga jisme objects hoga aur haar object me kuch data hoga -> image aur name
...
function showTheCards(){
    ...
    clutter += `<div class="box"><img class="cursor-pointer" src="${obj.image}" alt="image"><div class="caption">Lorem ipsum </div></div>`;
    })
